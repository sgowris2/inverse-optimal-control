...
switch intersectionName
    case 'GreenFirst'
        ...
        maneuvers{1} = [68513,68529,68532];
        maneuvers{2} = [68524,68515,68530];
        maneuvers{3} = [68528,68522,68531];
        maneuvers{4} = [68523,68514,68533];
        lInitial{1} = [5 5 5 5];     % Initial queue lengths at each link
