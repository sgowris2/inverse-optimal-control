...
JPhase3Length = 0;
if featureSelection(37) == 1 && noOfPhasesInACycle >= 3
    j = 3;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase3Length = JPhase3Length + d^2;
    end    
end

JPhase4Length = 0;
if featureSelection(38) == 1 && noOfPhasesInACycle >= 4
    j = 4;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase4Length = JPhase4Length + d^2;
    end    
end
JPhase5Length = 0;
if featureSelection(39) == 1 && noOfPhasesInACycle >= 5
    j = 5;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase5Length = JPhase5Length + d^2;
    end    
end
JPhase6Length = 0;
if featureSelection(40) == 1 && noOfPhasesInACycle >= 6
    j = 6;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase6Length = JPhase6Length + d^2;
    end    
end
JPhase7Length = 0;
if featureSelection(41) == 1 && noOfPhasesInACycle >= 7
    j = 7;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase7Length = JPhase7Length + d^2;
    end    
end
JPhase8Length = 0;
if featureSelection(42) == 1 && noOfPhasesInACycle >= 8
    j = 8;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j)) - avgPhaseLength{dataSetLoopIndex}(j);
        JPhase8Length = JPhase8Length + d^2;
    end    
end
...
if featureSelectionIndex(1) ~= 0
   J = J + weights(featureSelectionIndex(1))*J1/1000;
   %/10; 
end
if featureSelectionIndex(2) ~= 0
   J = J + weights(featureSelectionIndex(2))*J2;
   %/1000000; 
end
if featureSelectionIndex(3) ~= 0
    J = J + weights(featureSelectionIndex(3))*JLink1;
end
if featureSelectionIndex(4) ~= 0
    J = J + weights(featureSelectionIndex(4))*JLink2;
end
if featureSelectionIndex(5) ~= 0
    J = J + weights(featureSelectionIndex(5))*JLink3;
end
if featureSelectionIndex(6) ~= 0
    J = J + weights(featureSelectionIndex(6))*JLink4;
end
if featureSelectionIndex(7) ~= 0
    J = J + weights(featureSelectionIndex(7))*JLink5;
end
if featureSelectionIndex(8) ~= 0
    J = J + weights(featureSelectionIndex(8))*JLink6;
end
if featureSelectionIndex(9) ~= 0
    J = J + weights(featureSelectionIndex(9))*JLink7;
end
if featureSelectionIndex(10) ~= 0
    J = J + weights(featureSelectionIndex(10))*JLink8;
end
if featureSelectionIndex(11) ~= 0
    J = J + weights(featureSelectionIndex(11))*JPhase1/50;
    %/(1000);
end
if featureSelectionIndex(12) ~= 0
    J = J + weights(featureSelectionIndex(12))*JPhase2;
    %/(1000);
end
if featureSelectionIndex(13) ~= 0
    J = J + weights(featureSelectionIndex(13))*JPhase3;
    %/(1000);
end
if featureSelectionIndex(14) ~= 0
    J = J + weights(featureSelectionIndex(14))*JPhase4;
    %/(1000);
end
if featureSelectionIndex(15) ~= 0
    J = J + weights(featureSelectionIndex(15))*JPhase5;
    %/(1000);
end
if featureSelectionIndex(16) ~= 0
    J = J + weights(featureSelectionIndex(16))*JPhase6;
    %/(1000);
end
if featureSelectionIndex(17) ~= 0
    J = J + weights(featureSelectionIndex(17))*JPhase7;
    %/(1000);
end
if featureSelectionIndex(18) ~= 0
    J = J + weights(featureSelectionIndex(18))*JPhase8;
    %/(1000);
end
if featureSelectionIndex(19) ~= 0
    J = J + weights(featureSelectionIndex(19))*JLink1Sensor;
end
if featureSelectionIndex(20) ~= 0
    J = J + weights(featureSelectionIndex(20))*JLink2Sensor;
end
if featureSelectionIndex(21) ~= 0
    J = J + weights(featureSelectionIndex(21))*JLink3Sensor;
end
if featureSelectionIndex(22) ~= 0
    J = J + weights(featureSelectionIndex(22))*JLink4Sensor;
end
if featureSelectionIndex(23) ~= 0
    J = J + weights(featureSelectionIndex(23))*JLink5Sensor;
end
if featureSelectionIndex(24) ~= 0
    J = J + weights(featureSelectionIndex(24))*JLink6Sensor;
end
if featureSelectionIndex(25) ~= 0
    J = J + weights(featureSelectionIndex(25))*JLink7Sensor;
end
if featureSelectionIndex(26) ~= 0
    J = J + weights(featureSelectionIndex(26))*JLink8Sensor;
end
if featureSelectionIndex(27) ~= 0
    J = J + weights(featureSelectionIndex(27))*JLink1ConvexSensor;
end
if featureSelectionIndex(28) ~= 0
    J = J + weights(featureSelectionIndex(28))*JLink2ConvexSensor;
end
if featureSelectionIndex(29) ~= 0
    J = J + weights(featureSelectionIndex(29))*JLink3ConvexSensor;
end
if featureSelectionIndex(30) ~= 0
    J = J + weights(featureSelectionIndex(30))*JLink4ConvexSensor;
end
if featureSelectionIndex(31) ~= 0
    J = J + weights(featureSelectionIndex(31))*JLink5ConvexSensor;
end
if featureSelectionIndex(32) ~= 0
    J = J + weights(featureSelectionIndex(32))*JLink6ConvexSensor;
end
if featureSelectionIndex(33) ~= 0
    J = J + weights(featureSelectionIndex(33))*JLink7ConvexSensor;
end
if featureSelectionIndex(34) ~= 0
    J = J + weights(featureSelectionIndex(34))*JLink8ConvexSensor;
end
...
if featureSelectionIndex(37) ~= 0
    J = J + weights(featureSelectionIndex(37))*JPhase3Length;
    %/(10^2.5)
end
if featureSelectionIndex(38) ~= 0
    J = J + weights(featureSelectionIndex(38))*JPhase4Length;
    %/(10^2.5)
end
if featureSelectionIndex(39) ~= 0
    J = J + weights(featureSelectionIndex(39))*JPhase5Length;
    %/(10^2.5)
end
if featureSelectionIndex(40) ~= 0
    J = J + weights(featureSelectionIndex(40))*JPhase6Length;
    %/(10^2.5)
end
if featureSelectionIndex(41) ~= 0
    J = J + weights(featureSelectionIndex(41))*JPhase7Length;
    %/(10^2.5)
end
if featureSelectionIndex(42) ~= 0
    J = J + weights(featureSelectionIndex(42))*JPhase8Length;
    %/(10^2.5)
end
