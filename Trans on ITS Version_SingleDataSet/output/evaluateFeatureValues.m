function [J featureArray] = evaluateFeatureValues(x)
...
JPhase1Length = 0;
if featureSelection(27) == 1 && noOfPhasesInACycle >= 1
    w = weights(featureSelectionIndex(27));
    j = 1;
    for c = 1:cMax
...
JPhase2Length = 0;
if featureSelection(28) == 1 && noOfPhasesInACycle >= 2
    w = weights(featureSelectionIndex(28));
    j = 2;
    for c = 1:cMax
        d = x(delta(noOfPhasesInACycle*(c-1)+j));
...
if featureSelectionIndex(1) ~= 0
   J = J + weights(featureSelectionIndex(1))*J1;
   %/10; 
end
...
if featureSelectionIndex(11) ~= 0
    J = J + weights(featureSelectionIndex(11))*JPhase1;
    %/(1000);
end
...
if featureSelectionIndex(19) ~= 0
    J = J + weights(featureSelectionIndex(19))*JLink1ConvexSensor;
end
if featureSelectionIndex(20) ~= 0
    J = J + weights(featureSelectionIndex(20))*JLink2ConvexSensor;
end
if featureSelectionIndex(21) ~= 0
    J = J + weights(featureSelectionIndex(21))*JLink3ConvexSensor;
end
if featureSelectionIndex(22) ~= 0
    J = J + weights(featureSelectionIndex(22))*JLink4ConvexSensor;
end
if featureSelectionIndex(23) ~= 0
    J = J + weights(featureSelectionIndex(23))*JLink5ConvexSensor;
end
if featureSelectionIndex(24) ~= 0
    J = J + weights(featureSelectionIndex(24))*JLink6ConvexSensor;
end
if featureSelectionIndex(25) ~= 0
    J = J + weights(featureSelectionIndex(25))*JLink7ConvexSensor;
end
if featureSelectionIndex(26) ~= 0
    J = J + weights(featureSelectionIndex(26))*JLink8ConvexSensor;
end
if featureSelectionIndex(27) ~= 0
    J = J + weights(featureSelectionIndex(27))*JPhase1Length;
    %/(10^2);
end
if featureSelectionIndex(28) ~= 0
    J = J + weights(featureSelectionIndex(28))*JPhase2Length;
    %/(10^2);
end

featureArray = [J1,J2,JLink1,JLink2,JLink3,JLink4,JLink5,JLink6,JLink7,JLink8,...
                JPhase1,JPhase2,JPhase3,JPhase4,JPhase5,JPhase6,JPhase7,JPhase8...
                JLink1ConvexSensor,JLink2ConvexSensor,JLink3ConvexSensor,JLink4ConvexSensor,...
                JLink5ConvexSensor,JLink6ConvexSensor,JLink7ConvexSensor,JLink8ConvexSensor,...
                JPhase1Length, JPhase2Length];